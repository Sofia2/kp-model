...
Antes de utilizar el KP/App modelo, le recomendamos que se familiarice con los conceptos básicos de la plataforma Sofia2. Están incluidos en la
...
* [launcher](launcher): contiene el código del contenedor del KP/App modelo.
* [FIRSTAPP](FIRSTAPP): contiene una aplicación básica gestionada por el contenedor.
